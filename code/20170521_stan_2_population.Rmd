...
ggmcmc::ggmcmc(ggs(fit.stan), file="../mod_fit_ggmcmc/mod_01_noIIV.pdf")
```
...
```{r, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
ggmcmc::ggmcmc(ggs(fit.stan), file="../mod_fit_ggmcmc/mod_02_withIIV.pdf")
```
...
fit.stan <-
  stan(file = "mod_02_withIIV_limVd.stan", data = data)
