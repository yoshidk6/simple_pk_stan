...
# Summary
Multiple ideas worked to avoid label switching, (1) weak prior on all parameters, (2) limit of Vd lower value (with weak priors), or (3) ordered variables for KA and KEL.  
(2) was picked for consistency with population model. 
